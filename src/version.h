...
// underscore(_). 
#define PLUGIN_NAME "closeFpAtNight"
// Describe what your plugin does
// We recommend you start the introduction with a third-person singular verb.
#define PLUGIN_INTRODUCTION "Close all fakePlayer at night,and start all fakePlayer at day."
#define PLUGIN_AUTHOR "yuhub233"
